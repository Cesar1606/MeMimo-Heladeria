...
export default function Footer() {
  return (
    <footer className="py-10 px-4 sm:px-6 bg-black/90 text-white transition-colors duration-500">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:gap-6 text-center md:text-left">
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 mb-4 md:mb-0"
        >
          <img src="/img/logo.png" alt="Logo Memimo" className="h-10 w-auto mx-auto" />
          <span className="font-poppins text-base sm:text-lg font-semibold text-white/80">Hecho con <span className="text-red-600">♥</span> en Huancayo, Perú</span>
        </motion.div>
        {/* Redes sociales */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          ...
          className="flex items-center justify-center gap-6 text-2xl mb-4 md:mb-0"
        >
        ...
        <motion.div
          ...
          className="text-center md:text-right text-xs sm:text-sm font-inter text-white/60"
        >
